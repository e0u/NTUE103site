...
<html xmlns:fb="http://ogp.me/ns/fb#">
  ...
  <body>
    ...
    <div class="container"> 
    <form class="form-editabout">
		<div class="form-group has-success has-feedback">
        <label class="control-label col-sm-1" for="inputSuccess3">標題</label>
        <div class="col-sm-3">
          <input type="text" class="form-control" placeholder="請輸入年度" value="">
        </div>
        <textarea rows="20" class="form-control" >
NOTE:
建立方式>>
每隔一行代表一項能力指標，輸入完畢後按存檔即可
----------------請記得把上面的說明全部刪掉，不然這也會變成能力指標--------------------
        </textarea>
