...
<html xmlns:fb="http://ogp.me/ns/fb#">
  ...
  <body>
    ...
    <div class="container"> 
    <form class="form-editabout" action="item_core_add.php">
		<div class="form-group has-success has-feedback">
    <div class="row">
  <div class="col-xs-12 col-md-8">103年</div>
  <div class="col-xs-6 col-md-4"><a href="item_core_edit103.php">編輯</a></div>
    </div>
	  <button type="submit"  class="btn btn-primary">新增年度</button>
    </form>
