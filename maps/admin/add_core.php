  ...
  <body>
    ...
    <form class="form-add">
	  ...
	  <table width="100%" class="table-bordered">
	    ...
	    <tr>
	      <td><input type="text" class="form-control input-sm" placeholder="科目名稱"></td>
	      ...
	      <td><input type="checkbox" id="inlineCheckbox2" value="1"></td>
	      <td><input type="checkbox" id="inlineCheckbox3" value="1"></td>
	      ...
	      <td><input type="checkbox" id="inlineCheckbox7" value="1"></td>
